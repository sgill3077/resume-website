...
This repository contains the source code for my personal resume website. It's a simple, responsive web page designed to showcase my professional background, skills, and projects. The website is built with HTML, CSS, and JavaScript.
...
```bash
git clone https://github.com/sgill3077/resume-website.git
```
